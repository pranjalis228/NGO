    ...
    <section>
        <div class="login_pic">
            ...
            <div class="intro1">
              ...
              <p>
                  <a style="color: black" href ="forgetpassword.php">Forgot password?</a> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
                  <a style="color:black"href="admin_registration.php">SIGN UP</a>
              </p>
            </div></div>
